...
def prepare_cluster_data(
    ...
    for cluster, color in cluster_colors_dataframe.df.select(
        ...
        for row in cluster_differences.iter_rows(named=True):
            ...
            if taxon_info.height > 0 and abs(percent_diff) > ClusterSignificantDifferencesDataFrame.THRESHOLD:
                species_data = {
...
def prepare_full_report_data(
    ...
    for cluster in clusters:
        ...
        map_img_base64 = plot_single_cluster(feature_collection, cluster, to_base64=True)
