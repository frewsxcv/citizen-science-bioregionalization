...
def build_cluster_significant_differences_df(
    ...
    for cluster in iter_cluster_ids(all_stats):
        ...
        for taxonId, count in (
            ...
            if count < ClusterSignificantDifferencesSchema.MIN_COUNT_THRESHOLD:
                continue
            ...
            if neighbor_count < ClusterSignificantDifferencesSchema.MIN_COUNT_THRESHOLD:
                continue
            ...
            if p_value < ClusterSignificantDifferencesSchema.P_VALUE_THRESHOLD:
