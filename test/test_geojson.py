...
class TestGeojson(unittest.TestCase):
    ...
    def test_ocean_clusters(self):
        ...
        self.assertTrue(is_cluster_mostly_ocean(cluster_boundary_df, 3, threshold=0.5))
        ...
        ocean_clusters = find_ocean_clusters(cluster_boundary_df, threshold=0.5)
        self.assertIn(
        ...
        ocean_clusters_high = find_ocean_clusters(cluster_boundary_df, threshold=0.99)

        # With a very low threshold, we should at least get cluster 3
        ocean_clusters_low = find_ocean_clusters(cluster_boundary_df, threshold=0.01)
        self.assertIn(
            3,
            ocean_clusters_low,
