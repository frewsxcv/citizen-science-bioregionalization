...
from src.geojson import build_geojson_feature_collection, is_cluster_mostly_ocean, find_ocean_clusters
...
class TestGeojson(unittest.TestCase):
    ...
    def test_ocean_clusters(self):
        ...
        self.assertTrue(is_cluster_mostly_ocean(cluster_boundary_dataframe, 3, threshold=0.5))
        ...
        self.assertIn(3, ocean_clusters, "Cluster 3 should be identified as an ocean cluster")
        
        # With a very high threshold (0.99), we may or may not get any clusters
        # depending on the exact ocean data
        ocean_clusters_high = find_ocean_clusters(cluster_boundary_dataframe, threshold=0.99)
        
        # With a very low threshold, we should at least get cluster 3
        ocean_clusters_low = find_ocean_clusters(cluster_boundary_dataframe, threshold=0.01)
        self.assertIn(3, ocean_clusters_low, "Cluster 3 should be identified as an ocean cluster with low threshold")
