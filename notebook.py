...
def _(
    ...
    # hand-written table had drifted: 23 rows covering 19 settings, and it never
    # showed sample_records or default_display_level at all.
...
@app.cell
def _(config, darwin_core_lf, geocode_no_edges_lf, materialize_parquet):
...
def _(all_clusters_df, config, geocode_distance_matrix):
    ...
    selector_k = select_k(all_cluster_metrics, pinned_k=config.num_clusters_pinned)
